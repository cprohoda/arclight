...
mod tests {
    ...
    fn hello_world_test() {
        ...
        assert_eq!("fn main() {\nprintln!(\"Hello world!\");\n}".to_string(), hello_world.generate().expect("Testing hello_world_test, hello_world generate"));
    }
    ...
    fn hello_world_two_arg_test() {
        ...
        assert_eq!("fn main() {\nprintln!(\"{}\",\"Hello world!\");\n}".to_string(), hello_world.generate().expect("Testing hello_world_two_arg_test, hello_world_generate"));
    }
}
